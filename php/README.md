# AiPresentationGenerator PHP SDK



The PHP SDK for the AiPresentationGenerator API — an entity-oriented client using PHP conventions.
...
```
php/
├── aipresentationgenerator_sdk.php          -- Main SDK class
...
The main class (`aipresentationgenerator_sdk.php`) exports the SDK class
