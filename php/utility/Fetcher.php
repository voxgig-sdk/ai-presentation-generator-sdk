...
// AiPresentationGenerator SDK utility: fetcher

class AiPresentationGeneratorFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; AiPresentationGeneratorSDK/1.0)';
    ...
    public static function call(AiPresentationGeneratorContext $ctx, string $fullurl, array $fetchdef): array
    {
