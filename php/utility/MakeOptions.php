...
// AiPresentationGenerator SDK utility: make_options

class AiPresentationGeneratorMakeOptions
{
    ...
    public static function call(AiPresentationGeneratorContext $ctx): array
    {
        ...
        //
        // `AiPresentationGeneratorSchema::optspec()` is built from the model:
        ...
        $optspec = AiPresentationGeneratorSchema::optspec();
