...
// AiPresentationGenerator SDK utility: make_request

require_once __DIR__ . '/../core/Response.php';
require_once __DIR__ . '/../core/Result.php';

class AiPresentationGeneratorMakeRequest
{
    public static function call(AiPresentationGeneratorContext $ctx): array
    {
        ...
        if ($fetch_err) {
            ...
            $response = new AiPresentationGeneratorResponse(['err' => $ctx->make_error('request_no_response', 'response: undefined')]);
        } elseif (is_array($fetched)) {
            $response = new AiPresentationGeneratorResponse($fetched);
        } else {
