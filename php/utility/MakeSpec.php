...
// AiPresentationGenerator SDK utility: make_spec

require_once __DIR__ . '/Graphql.php';

require_once __DIR__ . '/../core/Spec.php';

class AiPresentationGeneratorMakeSpec
{
    public static function call(AiPresentationGeneratorContext $ctx): array
    {
        ...
        if ('graphql' === \Voxgig\Struct\Struct::getprop($point, 'kind')) {
            ...
            $ctx->spec->query = [];
            $ctx->spec->headers['content-type'] = AiPresentationGeneratorGraphql::CONTENT_TYPE;
        } else {
