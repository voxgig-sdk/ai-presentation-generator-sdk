...
// AiPresentationGenerator SDK clienttrack feature
...
class AiPresentationGeneratorClienttrackFeature extends AiPresentationGeneratorBaseFeature
{
    ...
    public function PostConstruct(AiPresentationGeneratorContext $_ctx): void
    {
        if (!$this->active) {
            return;
        }
    ...
    private function _name(): string
    {
        ...
        $name = (is_string($name) && $name !== '') ? $name : 'AiPresentationGenerator-SDK';
