...
// AiPresentationGenerator SDK streaming feature
...
class AiPresentationGeneratorStreamingFeature extends AiPresentationGeneratorBaseFeature
{
    ...
    private function _iterate(AiPresentationGeneratorResult $result): \Generator
    {
    ...
    private function _streamable(AiPresentationGeneratorContext $ctx): bool
    {
