...
// AiPresentationGenerator SDK paging feature
...
class AiPresentationGeneratorPagingFeature extends AiPresentationGeneratorBaseFeature
{
    ...
    private function _is_list(AiPresentationGeneratorContext $ctx): bool
    {
