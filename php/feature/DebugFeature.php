...
// AiPresentationGenerator SDK debug feature
...
class AiPresentationGeneratorDebugFeature extends AiPresentationGeneratorBaseFeature
{
    ...
    private function _finish(AiPresentationGeneratorContext $ctx, bool $ok): void
    {
