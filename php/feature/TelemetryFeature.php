...
// AiPresentationGenerator SDK telemetry feature
...
class AiPresentationGeneratorTelemetryFeature extends AiPresentationGeneratorBaseFeature
{
    ...
    private function _close(AiPresentationGeneratorContext $ctx, bool $ok): void
    {
