...
// AiPresentationGenerator SDK cache feature
...
class AiPresentationGeneratorCacheFeature extends AiPresentationGeneratorBaseFeature
{
    ...
    private function _through(AiPresentationGeneratorContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
