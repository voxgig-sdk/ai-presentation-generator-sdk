...
// AiPresentationGenerator SDK metrics feature
...
class AiPresentationGeneratorMetricsFeature extends AiPresentationGeneratorBaseFeature
{
    ...
    private function _record(AiPresentationGeneratorContext $ctx, bool $ok): void
    {
