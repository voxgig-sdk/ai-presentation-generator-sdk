...
// AiPresentationGenerator SDK utility type

class AiPresentationGeneratorUtility
{
    ...
    public static function copy(AiPresentationGeneratorUtility $src): AiPresentationGeneratorUtility
    {
        $u = new AiPresentationGeneratorUtility();
        $u->clean = $src->clean;
        $u->done = $src->done;
