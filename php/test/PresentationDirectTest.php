...
class PresentationDirectTest extends TestCase
{
    public function test_direct_load_presentation(): void
    {
        $setup = presentation_direct_setup(["id" => "direct01"]);
        [$_shouldSkip, $_reason] = Runner::is_control_skipped("direct", "direct-load-presentation", $setup["live"] ? "live" : "unit");
        if ($_shouldSkip) {
