...
// AiPresentationGenerator SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (AiPresentationGeneratorSDK::test)
...
{
    private const SDK_CLASS = 'AiPresentationGeneratorSDK';
    ...
    private const SDK_BASE = 'aipresentationgenerator_sdk';
    ...
    public function test_php_examples_run_offline(): void
    {
        $ran = 0;
        $failures = [];
        $sdk = __DIR__ . '/../aipresentationgenerator_sdk.php';
        foreach ($this->phpBlocks() as $blk) {
