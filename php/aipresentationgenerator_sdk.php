...
class AiPresentationGeneratorSDK
{
    ...
    public function __construct(array $options = [])
    {
        ...
        $feature_opts = AiPresentationGeneratorHelpers::to_map(Struct::getprop($this->options, "feature"));
        if ($feature_opts) {
            $featureorder = Struct::getpath($this->options, "__derived__.featureorder");
            if (is_array($featureorder)) {
                foreach ($featureorder as $fname) {
                    $fopts = AiPresentationGeneratorHelpers::to_map($feature_opts[$fname] ?? null);
                    if ($fopts && isset($fopts["active"]) && $fopts["active"] === true) {
                        ...
                        if (!AiPresentationGeneratorFeatures::has_feature($fname)) {
                        ...
                        ($utility->feature_add)($this->_rootctx, AiPresentationGeneratorFeatures::make_feature($fname));
                    }
                }
            }
        }
    ...
    {
        return AiPresentationGeneratorUtility::copy($this->_utility);
    }
    ...
    public function prepare(array $fetchargs = []): mixed
    {
        ...
        $ctrl = AiPresentationGeneratorHelpers::to_map(Struct::getprop($fetchargs, "ctrl")) ?? [];
        ...
        $params = AiPresentationGeneratorHelpers::to_map(Struct::getprop($fetchargs, "params")) ?? [];
        $query = AiPresentationGeneratorHelpers::to_map(Struct::getprop($fetchargs, "query")) ?? [];
    ...
    private function op_denied(string $op): array
    {
        ...
        return [
            "ok" => false,
            "err" => new AiPresentationGeneratorError($op . "_allow",
                "AiPresentationGeneratorSDK: " . $op . ": operation not allowed by" .
    ...
    private function raw_request(array $fetchargs = []): mixed
    {
        ...
        if (is_array($fetched)) {
            $status = AiPresentationGeneratorHelpers::to_int(Struct::getprop($fetched, "status"));
    ...
    public function graphql(string $query, ?array $variables = null, ?array $ctrl = null): mixed
    {
        ...
        if (is_array($errors) && 0 < count($errors)) {
            ...
            $res["ok"] = false;
            $res["err"] = new AiPresentationGeneratorError("graphql_error",
                "AiPresentationGeneratorSDK: graphql: " . $msg);
            $res["graphql"] = $errors;
        }
    ...
    public function Presentation($data = null)
    {
        ...
        if ($data === null) {
            if ($this->_presentation === null) {
                $this->_presentation = new PresentationEntity($this, null);
            }
            return $this->_presentation;
        }
        return new PresentationEntity($this, $data);
    }
    ...
    public static function test(?array $testopts = null, ?array $sdkopts = null): self
    {
        ...
        $sdk = new AiPresentationGeneratorSDK($sdkopts);
        $sdk->mode = "test";
        return $sdk;
    }
}
