...
// AiPresentationGenerator SDK utility: graphql
//
...
class AiPresentationGeneratorGraphql
{
    ...
    // equivalent.
    public static function body(AiPresentationGeneratorContext $ctx): mixed
    {
    ...
    public static function errors(AiPresentationGeneratorContext $ctx): bool
    {
        $result = $ctx->result;
        $point = $ctx->point;
