...
// AiPresentationGenerator SDK ratelimit feature
...
class AiPresentationGeneratorRatelimitFeature extends AiPresentationGeneratorBaseFeature
{
    ...
    private function _acquire(AiPresentationGeneratorContext $ctx): void
    {
    ...
    private function _track(AiPresentationGeneratorContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;
