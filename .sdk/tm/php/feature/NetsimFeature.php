...
// AiPresentationGenerator SDK netsim feature
...
class AiPresentationGeneratorNetsimFeature extends AiPresentationGeneratorBaseFeature
{
    ...
    private function _simulate(AiPresentationGeneratorContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
        $opts = $this->options ?? [];
        $this->calls++;
        $call = $this->calls;
    ...
    private function _track(AiPresentationGeneratorContext $ctx, array $applied): void
    {
        $client = $this->client;
