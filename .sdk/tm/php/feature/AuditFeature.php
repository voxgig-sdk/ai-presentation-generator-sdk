...
// AiPresentationGenerator SDK audit feature
...
class AiPresentationGeneratorAuditFeature extends AiPresentationGeneratorBaseFeature
{
    ...
    private function _emit(AiPresentationGeneratorContext $ctx, string $outcome): void
    {
