...
// AiPresentationGenerator SDK rbac feature
...
class AiPresentationGeneratorRbacFeature extends AiPresentationGeneratorBaseFeature
{
    ...
    private function _required(AiPresentationGeneratorContext $ctx): ?string
    {
    ...
    private function _reject(AiPresentationGeneratorContext $ctx, string $required): void
    {
    ...
    private function _track(AiPresentationGeneratorContext $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;
