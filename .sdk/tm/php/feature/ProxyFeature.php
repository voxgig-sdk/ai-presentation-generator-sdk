...
// AiPresentationGenerator SDK proxy feature
...
class AiPresentationGeneratorProxyFeature extends AiPresentationGeneratorBaseFeature
{
    ...
    public function init(AiPresentationGeneratorContext $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (AiPresentationGeneratorContext $ctx2, string $url2, array $fetchdef) use ($inner): array {
