...
// AiPresentationGenerator SDK timeout feature
...
class AiPresentationGeneratorTimeoutFeature extends AiPresentationGeneratorBaseFeature
{
    ...
    private function _with_timeout(AiPresentationGeneratorContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(AiPresentationGeneratorContext $_ctx, float $ms): void
    {
        $client = $this->client;
