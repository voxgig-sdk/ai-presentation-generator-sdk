...
// AiPresentationGenerator SDK pipeline test
//
...
{
    private static function utility(): AiPresentationGeneratorUtility
    {
        return new AiPresentationGeneratorUtility();
    }
    ...
    private static function ctx(array $over = []): AiPresentationGeneratorContext
    {
        $utility = $over['utility'] ?? self::utility();
        $client = $over['client'] ?? new PlClient(['base' => 'http://h']);
        $ctx = new AiPresentationGeneratorContext([
            'client' => $client,
            'utility' => $utility,
        ], null);
        $ctx->op = new AiPresentationGeneratorOperation(['name' => 'load', 'entity' => 'x']);
        foreach ($over as $k => $v) {
    ...
    {
        return ($err instanceof AiPresentationGeneratorError) ? $err->sdk_code : '';
    }
    ...
    public function test_make_point_rejects_a_disallowed_operation(): void
    {
        ...
        $ctx->op = new AiPresentationGeneratorOperation(['name' => 'nope', 'entity' => 'x']);
        [$point, $err] = AiPresentationGeneratorMakePoint::call($ctx);
    ...
    public function test_make_point_rejects_an_operation_with_no_endpoints(): void
    {
        ...
        $ctx->op = new AiPresentationGeneratorOperation(['name' => 'load', 'entity' => 'x', 'points' => []]);
        [$point, $err] = AiPresentationGeneratorMakePoint::call($ctx);
        $this->assertNull($point);
    ...
    public function test_make_point_returns_the_single_point(): void
    {
        ...
        $ctx = self::ctx(['options' => ['allow' => ['op' => 'load,list,create,update,remove']]]);
        $ctx->op = new AiPresentationGeneratorOperation(['name' => 'load', 'entity' => 'x', 'points' => [$point]]);
        [$got, $err] = AiPresentationGeneratorMakePoint::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new AiPresentationGeneratorSpec(['method' => 'GET']);
        $ctx = self::ctx();
        $ctx->out['spec'] = $preset;
        [$got, $err] = AiPresentationGeneratorMakeSpec::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_response_guards_missing_spec_response_result(): void
    {
        $ctx = self::ctx([
            'spec' => null,
            'response' => new AiPresentationGeneratorResponse([]),
            'result' => new AiPresentationGeneratorResult([]),
        ]);
        [, $err] = AiPresentationGeneratorMakeResponse::call($ctx);
        $this->assertSame('response_no_spec', self::code($err));

        $ctx = self::ctx([
            'spec' => new AiPresentationGeneratorSpec([]),
            'response' => null,
            'result' => new AiPresentationGeneratorResult([]),
        ]);
        [, $err] = AiPresentationGeneratorMakeResponse::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'spec' => new AiPresentationGeneratorSpec(['step' => 's']),
            'response' => new AiPresentationGeneratorResponse(self::resp(404, null, ['x-a' => '1'])),
            'result' => new AiPresentationGeneratorResult([]),
        ]);
        [, $err] = AiPresentationGeneratorMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_2xx_parses_the_body_and_marks_ok(): void
    {
        $ctx = self::ctx([
            'spec' => new AiPresentationGeneratorSpec(['step' => 's']),
            'response' => new AiPresentationGeneratorResponse(self::resp(200, ['v' => 1])),
            'result' => new AiPresentationGeneratorResult([]),
        ]);
        [, $err] = AiPresentationGeneratorMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_records_to_ctrl_explain_when_explain_is_on(): void
    {
        $ctx = self::ctx([
            'spec' => new AiPresentationGeneratorSpec(['step' => 's']),
            'response' => new AiPresentationGeneratorResponse(self::resp(200, ['v' => 2])),
            'result' => new AiPresentationGeneratorResult([]),
        ]);
        $ctx->ctrl->explain = ['on' => true];
        AiPresentationGeneratorMakeResponse::call($ctx);
    ...
    {
        $preset = new AiPresentationGeneratorResponse(self::resp(299));
        $ctx = self::ctx([
            'spec' => new AiPresentationGeneratorSpec([]),
            'response' => new AiPresentationGeneratorResponse([]),
            'result' => new AiPresentationGeneratorResult([]),
        ...
        [$got, $err] = AiPresentationGeneratorMakeResponse::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null, 'result' => new AiPresentationGeneratorResult([])]);
        [, $err] = AiPresentationGeneratorMakeResult::call($ctx);
        $this->assertSame('result_no_spec', self::code($err));

        $ctx = self::ctx(['spec' => new AiPresentationGeneratorSpec([]), 'result' => null]);
        [, $err] = AiPresentationGeneratorMakeResult::call($ctx);
    ...
    public function test_make_result_list_op_wraps_resdata_into_entity_instances(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new AiPresentationGeneratorSpec(['step' => 's']),
            'result' => new AiPresentationGeneratorResult(['ok' => true, 'resdata' => [['a' => 1], ['a' => 2]]]),
        ]);
        $ctx->op = new AiPresentationGeneratorOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = AiPresentationGeneratorMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_result_empty_list_yields_empty_resdata(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new AiPresentationGeneratorSpec(['step' => 's']),
            'result' => new AiPresentationGeneratorResult(['ok' => true, 'resdata' => []]),
        ]);
        $ctx->op = new AiPresentationGeneratorOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = AiPresentationGeneratorMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new AiPresentationGeneratorResult(['ok' => true]);
        $ctx = self::ctx([
            'spec' => new AiPresentationGeneratorSpec([]),
            'result' => new AiPresentationGeneratorResult([]),
        ]);
        $ctx->out['result'] = $preset;
        [$got, $err] = AiPresentationGeneratorMakeResult::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_request_guards_a_missing_spec(): void
    {
        ...
        [, $err] = AiPresentationGeneratorMakeRequest::call($ctx);
    ...
    {
        $utility = self::utility();
        $boom = new AiPresentationGeneratorError('boom', 'boom');
        $utility->fetcher = function (AiPresentationGeneratorContext $_c, string $_u, array $_f) use ($boom): array {
            return [null, $boom];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new AiPresentationGeneratorSpec(['step' => 's', 'method' => 'GET', 'base' => 'http://h', 'parts' => ['a']]),
        ]);
        [$response, $err] = AiPresentationGeneratorMakeRequest::call($ctx);
        $this->assertNull($err);
    ...
    {
        $utility = self::utility();
        $utility->fetcher = function (AiPresentationGeneratorContext $_c, string $_u, array $_f): array {
            return [null, null];
        };
        $ctx = self::ctx([
            'utility' => $utility,
    ...
    public function test_make_request_a_normal_transport_response_is_wrapped(): void
    {
        ...
        [$response, $err] = AiPresentationGeneratorMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertInstanceOf(AiPresentationGeneratorResponse::class, $response);
    ...
    public function test_make_request_records_the_fetchdef_to_ctrl_explain(): void
    {
        ...
        $ctx->ctrl->explain = ['on' => true];
        AiPresentationGeneratorMakeRequest::call($ctx);
    ...
    {
        $utility = self::utility();
        $utility->make_fetch_def = function (AiPresentationGeneratorContext $c): array {
            return [null, $c->make_error('fetchdef_boom', 'boom')];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new AiPresentationGeneratorSpec(['step' => 's', 'method' => 'GET']),
        ]);
        [$response, $err] = AiPresentationGeneratorMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertNotNull($response->err);
    ...
    {
        $preset = new AiPresentationGeneratorResponse(self::resp(201));
        $ctx = self::ctx(['spec' => new AiPresentationGeneratorSpec([])]);
        $ctx->out['request'] = $preset;
        [$got, $err] = AiPresentationGeneratorMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null]);
        [, $err] = AiPresentationGeneratorMakeFetchDef::call($ctx);
    ...
    public function test_make_fetch_def_serialises_body_and_inits_missing_result(): void
    {
        ...
        [$fetchdef, $err] = AiPresentationGeneratorMakeFetchDef::call($ctx);
        $this->assertNull($err);
    ...
    {
        $ctx = self::ctx(['result' => new AiPresentationGeneratorResult(['ok' => true, 'resdata' => 42])]);
        $this->assertSame(42, AiPresentationGeneratorDone::call($ctx));
    }

    public function test_done_raises_the_error_when_not_ok(): void
    {
        $ctx = self::ctx(['result' => new AiPresentationGeneratorResult(['ok' => false])]);
        $this->expectException(AiPresentationGeneratorError::class);
        AiPresentationGeneratorDone::call($ctx);
    }

    public function test_make_error_returns_resdata_when_ctrl_throw_is_false(): void
    {
        $ctx = self::ctx(['result' => new AiPresentationGeneratorResult(['ok' => false, 'resdata' => 'fallback'])]);
        $ctx->ctrl->throw_err = false;
        $this->assertSame('fallback', AiPresentationGeneratorMakeError::call($ctx, null));
    }
    ...
    public function test_make_error_records_to_ctrl_explain(): void
    {
        ...
        $ctx->ctrl->throw_err = false;
        $ctx->ctrl->explain = ['on' => true];
        AiPresentationGeneratorMakeError::call($ctx, null);
    ...
    public function test_feature_add_appends_in_call_order(): void
    {
        ...
        $a = new AiPresentationGeneratorBaseFeature();
        $b = new AiPresentationGeneratorBaseFeature();
        AiPresentationGeneratorFeatureAdd::call($ctx, $a);
        AiPresentationGeneratorFeatureAdd::call($ctx, $b);
        $this->assertSame([$a, $b], $client->features);
    }

    private static function named_feature(string $name): AiPresentationGeneratorBaseFeature
    {
        $f = new AiPresentationGeneratorBaseFeature();
        $f->name = $name;
        return $f;
    }
    ...
    public function test_feature_add_ordering_before_after_replace(): void
    {
        ...
        AiPresentationGeneratorFeatureAdd::call($ctx, self::named_feature('a'));
        AiPresentationGeneratorFeatureAdd::call($ctx, self::named_feature('b'));
        $this->assertSame(['a', 'b'], $names());

        $before = self::named_feature('z1');
        $before->_options = ['__before__' => 'b'];
        AiPresentationGeneratorFeatureAdd::call($ctx, $before);
        $this->assertSame(['a', 'z1', 'b'], $names());

        $after = self::named_feature('z2');
        $after->_options = ['__after__' => 'a'];
        AiPresentationGeneratorFeatureAdd::call($ctx, $after);
        $this->assertSame(['a', 'z2', 'z1', 'b'], $names());

        $replace = self::named_feature('z3');
        $replace->_options = ['__replace__' => 'z1'];
        AiPresentationGeneratorFeatureAdd::call($ctx, $replace);
        ...
        AiPresentationGeneratorFeatureAdd::call($ctx, $miss);
    ...
    private static function auth_ctx(array $options, ?array $headers): AiPresentationGeneratorContext
    {
        $client = new PlClient($options);
        return self::ctx([
            'client' => $client,
            'spec' => $headers === null ? null : new AiPresentationGeneratorSpec(['headers' => $headers]),
        ]);
    }
    ...
    public function test_prepare_auth_guards_a_missing_spec(): void
    {
        ...
        [, $err] = AiPresentationGeneratorPrepareAuth::call($ctx);
    ...
    public function test_prepare_auth_a_raw_apikey_goes_in_as_is(): void
    {
        ...
        AiPresentationGeneratorPrepareAuth::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'response' => new AiPresentationGeneratorResponse(['headers' => null]),
            'result' => new AiPresentationGeneratorResult([]),
        ]);
        AiPresentationGeneratorResultHeaders::call($ctx);
    ...
    public function test_result_body_skips_parsing_when_the_body_is_absent(): void
    {
        ...
        AiPresentationGeneratorResultBody::call($ctx);
