...
|---|---|---|
| `ts/` | @voxgig-sdk/ai-presentation-generator-sdk | `.github/workflows/publish-ts.yml` |
...
required):
    ...
    npm trust github @voxgig-sdk/ai-presentation-generator-sdk \
      --repository voxgig-sdk/ai-presentation-generator-sdk \
      --file publish-ts.yml \
      --allow-publish

Then `npm trust list @voxgig-sdk/ai-presentation-generator-sdk` shows it, and
`npm trust revoke @voxgig-sdk/ai-presentation-generator-sdk --id=<id>` removes it.
