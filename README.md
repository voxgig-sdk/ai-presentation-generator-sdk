...
This API allows users to create professional and visually appealing presentations using AI technology.

Learn more about AI Presentation Generator at [pi.inc](https://pi.inc).
...
This SDK exposes the API as a small set of **semantic entities** — Presentation — that you
