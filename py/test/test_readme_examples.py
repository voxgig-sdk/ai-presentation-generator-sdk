# AiPresentationGenerator SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions AiPresentationGeneratorSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both AiPresentationGeneratorSDK(...) and AiPresentationGeneratorSDK.test(...) become
#      AiPresentationGeneratorSDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "aipresentationgenerator_sdk"
_SDK_CLASS = "AiPresentationGeneratorSDK"
