...
from aipresentationgenerator_sdk.utility import register

# Load features
from aipresentationgenerator_sdk.feature.base_feature import AiPresentationGeneratorBaseFeature
from aipresentationgenerator_sdk.features import _has_feature, _make_feature
...
class AiPresentationGeneratorSDK:
    ...
    def __init__(self, options=None):
        ...
        utility = AiPresentationGeneratorUtility()
        self._utility = utility

        from aipresentationgenerator_sdk.config import shared_config
    ...
    def get_utility(self):
        return AiPresentationGeneratorUtility.copy(self._utility)
    ...
    def graphql(self, query, variables=None, ctrl=None):
        ...
        if isinstance(errors, list) and 0 < len(errors):
            ...
            res["ok"] = False
            res["err"] = Exception("AiPresentationGeneratorSDK: graphql: " + str(msg))
            res["graphql"] = errors
    ...
    def Presentation(self, data=None) -> "PresentationEntity":
        ...
        from aipresentationgenerator_sdk.entity.presentation_entity import PresentationEntity
