...
from aipresentationgenerator_sdk.core.helpers import get_ctx_prop, to_map
...
class AiPresentationGeneratorContext:
    def __init__(self, ctxmap=None, basectx=None):
        ...
        # Ctrl
        self.ctrl = AiPresentationGeneratorControl()
        ...
        if isinstance(sp, AiPresentationGeneratorSpec):
            self.spec = sp
        elif basectx is not None:
        ...
        if isinstance(r, AiPresentationGeneratorResult):
            self.result = r
        elif basectx is not None:
        ...
        if isinstance(rp, AiPresentationGeneratorResponse):
            self.response = rp
        elif basectx is not None:
    ...
    def resolve_op(self, opname):
        ...
        if opname == "":
            return AiPresentationGeneratorOperation({})
        ...
        op = AiPresentationGeneratorOperation({
            "entity": entname,
            "name": opname,
            "input": inpt,
            "points": points,
    ...
    def make_error(self, code, msg):
        return AiPresentationGeneratorError(code, msg, self)
