...
const AiPresentationGeneratorError_1 = require("./AiPresentationGeneratorError");
...
class Context {
    ...
    error(code, msg) {
        return new AiPresentationGeneratorError_1.AiPresentationGeneratorError(code, msg, this);
    }
    toJSON() {
        return {
            id: this.id,
