...
function envOverride(m: Record<string, any>) {
  if (
    'TRUE' === process.env.AIPRESENTATIONGENERATOR_TEST_LIVE ||
    'TRUE' === process.env.AIPRESENTATIONGENERATOR_TEST_OVERRIDE
  ) {
  ...
  m.AIPRESENTATIONGENERATOR_TEST_EXPLAIN = process.env.AIPRESENTATIONGENERATOR_TEST_EXPLAIN || m.AIPRESENTATIONGENERATOR_TEST_EXPLAIN
