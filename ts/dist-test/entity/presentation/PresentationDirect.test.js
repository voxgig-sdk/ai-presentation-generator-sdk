...
(0, node_test_1.describe)('PresentationDirect', async () => {
    ...
    (0, node_test_1.test)('direct-exists', async () => {
        const sdk = new __1.AiPresentationGeneratorSDK({
    ...
    (0, node_test_1.test)('direct-load-presentation', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-presentation', setup.live))
            return;
...
function liveScenariosActive() { return false && process.env.AI_PRESENTATION_GENERATOR_TEST_LIVE === 'TRUE'; }
function directSetup(mockres) {
    ...
    if (live) {
        ...
        const client = new __1.AiPresentationGeneratorSDK(Object.assign({}, (0, utility_1.liveClientOptions)(), { system: { fetch: transport.fetch },
            apikey: env.AI_PRESENTATION_GENERATOR_APIKEY,
        }));
        let idmap = env['AI_PRESENTATION_GENERATOR_TEST_PRESENTATION_ENTID'];
    ...
    const client = new __1.AiPresentationGeneratorSDK({
        base: 'http://localhost:8080',
...
//# sourceMappingURL=PresentationDirect.test.js.map