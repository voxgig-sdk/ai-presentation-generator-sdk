...
function envOverride(m) {
    if ('TRUE' === process.env.AI_PRESENTATION_GENERATOR_TEST_LIVE ||
        'TRUE' === process.env.AI_PRESENTATION_GENERATOR_TEST_OVERRIDE) {
    ...
    m.AI_PRESENTATION_GENERATOR_TEST_EXPLAIN = process.env.AI_PRESENTATION_GENERATOR_TEST_EXPLAIN || m.AI_PRESENTATION_GENERATOR_TEST_EXPLAIN;
    return m;
}
