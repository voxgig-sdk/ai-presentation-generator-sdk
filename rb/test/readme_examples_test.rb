...
#      offline in seeded test mode (AiPresentationGeneratorSDK.test) against the real
...
class ReadmeExamplesTest < Minitest::Test
  ...
  SDK = File.join(__dir__, "..", "AiPresentationGenerator_sdk.rb")
  SDK_CLASS = "AiPresentationGeneratorSDK"
  ...
  SDK_BASE = "AiPresentationGenerator_sdk"
