# AiPresentationGenerator SDK feature corpus test
#
...
class FeatureCorpusTest < Minitest::Test
  ...
  #
  # AiPresentationGeneratorSDK.new, not AiPresentationGeneratorSDK.test: the `test` feature is
  ...
  def build_client(kase)
    ...
    AiPresentationGeneratorSDK.new(opts)
  end
