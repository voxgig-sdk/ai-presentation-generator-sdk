...
describe("PresentationDirect", function()
  it("should direct-load-presentation", function()
    local setup = presentation_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-presentation", setup.live and "live" or "unit")
...
function presentation_direct_setup(mockres)
