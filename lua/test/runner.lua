...
function runner.env_override(m)
  local live = runner.getenv("AI_PRESENTATION_GENERATOR_TEST_LIVE")
  local override = runner.getenv("AI_PRESENTATION_GENERATOR_TEST_OVERRIDE")
  ...
  local explain = runner.getenv("AI_PRESENTATION_GENERATOR_TEST_EXPLAIN")
