...
function runner.env_override(m)
  local live = runner.getenv("AIPRESENTATIONGENERATOR_TEST_LIVE")
  local override = runner.getenv("AIPRESENTATIONGENERATOR_TEST_OVERRIDE")
  ...
  local explain = runner.getenv("AIPRESENTATIONGENERATOR_TEST_EXPLAIN")
