// Command AiPresentationGenerator-mcp is an MCP server exposing the AiPresentationGenerator
// SDK as MCP tools.
//
// Two tools are registered:
//
//	AiPresentationGenerator_list  — list records of an entity
//	AiPresentationGenerator_load  — load a single record of an entity
//
