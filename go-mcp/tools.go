...
type Args struct {
	Entity string         `json:"entity" jsonschema:"presentation"`
	Query  map[string]any `json:"query,omitempty" jsonschema:"optional match map e.g. {\"id\":1} for load, omit for list"`
}

func registerTools(server *mcp.Server, client *sdk.AiPresentationGeneratorSDK) {
	mcp.AddTool(server, &mcp.Tool{
		Name: "ai-presentation-generator_list",
		Description: "List records from AiPresentationGenerator. " +
	...
	mcp.AddTool(server, &mcp.Tool{
		Name: "ai-presentation-generator_load",
		Description: "Load a single record from AiPresentationGenerator. " +
...
func runOp(client *sdk.AiPresentationGeneratorSDK, op string, args Args) (*mcp.CallToolResult, any, error) {
...
func entityFor(client *sdk.AiPresentationGeneratorSDK, name string) (sdk.AiPresentationGeneratorEntity, error) {
	switch strings.ToLower(name) {
	case "presentation":
		return client.Presentation(nil), nil
