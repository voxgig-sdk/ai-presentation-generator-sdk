# AiPresentationGenerator Golang SDK
...
## Install
```bash
go get github.com/voxgig-sdk/ai-presentation-generator-sdk/go@latest
```

The Go module proxy resolves the version from the `go/vX.Y.Z` GitHub
release tag — see [Releases](https://github.com/voxgig-sdk/ai-presentation-generator-sdk/releases) for the available versions.
...
```bash
go mod edit -replace github.com/voxgig-sdk/ai-presentation-generator-sdk/go=../ai-presentation-generator-sdk/go
```
...
### AiPresentationGeneratorSDK methods
...
| `Presentation` | `(data map[string]any) AiPresentationGeneratorEntity` | Create a Presentation entity instance. |

### Entity interface (AiPresentationGeneratorEntity)

All entities implement the `AiPresentationGeneratorEntity` interface.
...
Create an instance: `presentation := client.Presentation(nil)`
...
```go
presentation, err := client.Presentation(nil).Load(map[string]any{"id": "presentation_id"}, nil)
if err != nil {
    panic(err)
}
fmt.Println(presentation) // the loaded record
```
