...
func envOverride(m map[string]any) map[string]any {
	if os.Getenv("AIPRESENTATIONGENERATOR_TEST_LIVE") == "TRUE" ||
		os.Getenv("AIPRESENTATIONGENERATOR_TEST_OVERRIDE") == "TRUE" {
		for key := range m {
	...
	if explain := os.Getenv("AIPRESENTATIONGENERATOR_TEST_EXPLAIN"); explain != "" {
