...
AQL-driven CLI and REPL for the AiPresentationGenerator SDK. Positional arguments are
...
```sh
go build -o ai-presentation-generator-cli ./...
```
...
./ai-presentation-generator-cli list presentation
./ai-presentation-generator-cli load 1 presentation
./ai-presentation-generator-cli load '{id:1}' presentation
