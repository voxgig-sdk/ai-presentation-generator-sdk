...
func registerSDKWords(r *eng.Registry, client *sdk.AiPresentationGeneratorSDK) {
...
func runOp(client *sdk.AiPresentationGeneratorSDK, op string, query *eng.Value, entityAtom eng.Value) ([]eng.Value, error) {
